...
int main() {
    try {
        ...
        checks += material_catalog_read_tests();
        checks += view_sequence_tests();
        ...
        checks += material_projection_zero_kind_tests();
        ...
        checks += native_curve_frame_tests();
        ...
        checks += component_property_tests();
